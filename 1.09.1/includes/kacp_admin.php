...
function kacp_content_pizazz_options_page_setup(){
	...
	<div class="wrap">
		...
		<div class="kacp_paypal"><?php _e('Show your appreciation and make a donation!','testimonial-basics') ?>
		...
		<p>I wrote this plugin initially to supplement the blogBox theme. It will add a few features that can add a little pizazz 
			to your posts and pages. I hope you like it. If you do remember to make a donation. Either way I'd like to hear what you think about it, so go 
			to my site and put in a comment. You can also do a review at the plugin site in WordPress.org.</p>
		...
		<p>You don't have to remember all the shortcodes below because the toolbars above will help. 
			There will be a few options you may have to come back here for but the buttons should get you most of the way there.</p>
